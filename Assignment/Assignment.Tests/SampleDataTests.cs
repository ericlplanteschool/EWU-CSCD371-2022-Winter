...
namespace Assignment.Tests
{
    ...
    public class SampleDataTests
    {
        ...
        [TestMethod]
        public void GetUniqueSortedListOfStatesGivenCsvRows_SpokaneCompareToAllCities_WAOnlyListsIdentical()
        {
            // Arrange
        ...
        [TestMethod]
        public void GetUniqueSortedListOfStatesGivenCsvRows_Read_ListIsSortedAndUnique()
        {
            // Arrange
